            ...
            <ScrollReveal>
              <div>
                ...
                <p className="text-[17px] text-muted-foreground leading-relaxed">
                  World Student Advisors (WSA) is an international education advisory service founded in 2012. We have British Council UK knowledge-trained counsellors, with offices in the United Kingdom, Kenya, Nigeria, and Ghana. This privacy policy explains how we collect, use, and protect your personal information when you use our website or services.
                </p>
              </div>
            </ScrollReveal>

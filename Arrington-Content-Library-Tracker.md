...
Handed to the website worker: pieces 1-5 in handover 01, pieces 11-12 in handover 02, pieces 13-14 in handover 03, piece 15 in handover 04 — all delivered as Google Docs in the 09 Website folder (or the Brain root folder, for pieces 15-16) and confirmed via full download-and-decode (the more reliable check than content-snippet search, which truncates at ~5000 characters). Handover 03 carries a top-of-document confidentiality note covering both pieces' anonymisation requirement. Piece 16 has been created in Drive but not yet handed to the website worker in a numbered handover document — pending.
